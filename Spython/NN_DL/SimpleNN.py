...
class SimpleNN:
    ...
    def train(self, inputs, targets, learning_rate = 1):
        ...
        e_2 = targets - a_2
        e_1 = np.dot(self.weight_2.T, e_2)
        
        delat_w_2 = np.dot(learning_rate * e_2 * a_2 * (1 - a_2), a_1.T)
        delta_b_2 = learning_rate * e_2 * a_2 * (1 - a_2)
        delta_w_1 = np.dot(learning_rate * e_1 * a_1 * (1 - a_1), inputs.T)
        delta_b_1 = learning_rate * e_1 * a_1 * (1 - a_1)
        
        self.weight_2 = self.weight_2 + delat_w_2
        self.bias_2 = self.bias_2 + delta_b_2
        self.weight_1 = self.weight_1 + delta_w_1
        self.bias_1 = self.bias_1 + delta_b_1
